...
export CSF_XSTEPMessages="${CASROOT}/src/DataExchange/XSTEPMessages"
export CSF_TObjMessage="${CASROOT}/src/TObj"
export CSF_StandardDefaults="${CASROOT}/src/Foundation/StdResource"
export CSF_PluginDefaults="${CASROOT}/src/Foundation/StdResource"
export CSF_XCAFDefaults="${CASROOT}/src/Foundation/StdResource"
export CSF_TObjDefaults="${CASROOT}/src/Foundation/StdResource"
export CSF_StandardLiteDefaults="${CASROOT}/src/Foundation/StdResource"
export CSF_UnitsLexicon="${CASROOT}/src/Foundation/UnitsAPI/Lexi_Expr.dat"
export CSF_UnitsDefinition="${CASROOT}/src/Foundation/UnitsAPI/Units.dat"
...
export CSF_MIGRATION_TYPES="${CASROOT}/src/Foundation/StdResource/MigrationSheet.txt"
