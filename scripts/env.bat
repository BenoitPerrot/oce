...
set "CSF_XSTEPMessages=%CASROOT%\src\DataExchange\XSTEPMessages"
set "CSF_TObjMessage=%CASROOT%\src\TObj"
set "CSF_StandardDefaults=%CASROOT%\src\Foundation\StdResource"
set "CSF_PluginDefaults=%CASROOT%\src\Foundation\StdResource"
set "CSF_XCAFDefaults=%CASROOT%\src\Foundation\StdResource"
set "CSF_TObjDefaults=%CASROOT%\src\Foundation\StdResource"
set "CSF_StandardLiteDefaults=%CASROOT%\src\Foundation\StdResource"

set "CSF_UnitsLexicon=%CASROOT%\src\Foundation\UnitsAPI\Lexi_Expr.dat"
set "CSF_UnitsDefinition=%CASROOT%\src\Foundation\UnitsAPI\Units.dat"
...
set "CSF_MIGRATION_TYPES=%CASROOT%\src\Foundation\StdResource\MigrationSheet.txt"
