 ...
 const  TColGeom_Array2OfSurface& operator = (const TColGeom_Array2OfSurface& Other) 
{
  return Assign(Other);
   ...
   const  Handle(Geom_Surface)& operator() (const Standard_Integer Row, const Standard_Integer Col)  const
{
  return Value(Row,Col);
}
  
      Handle(Geom_Surface)& ChangeValue (const Standard_Integer Row, const Standard_Integer Col) ;
    Handle(Geom_Surface)& operator() (const Standard_Integer Row, const Standard_Integer Col) 
{
...
#endif // _TColGeom_Array2OfSurface_HeaderFile
