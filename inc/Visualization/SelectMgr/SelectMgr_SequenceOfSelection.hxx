...
#include <Visualization/SelectMgr/Handle_SelectMgr_SequenceNodeOfSequenceOfSelection.hxx>
 ...
 const  SelectMgr_SequenceOfSelection& operator = (const SelectMgr_SequenceOfSelection& Other) 
{
  ...
  Standard_EXPORT  const  Handle(SelectMgr_Selection)& First()  const;
  
  Standard_EXPORT  const  Handle(SelectMgr_Selection)& Last()  const;
  
      void Split (const Standard_Integer Index, SelectMgr_SequenceOfSelection& Sub) ;
  
  Standard_EXPORT  const  Handle(SelectMgr_Selection)& Value (const Standard_Integer Index)  const;
 const  Handle(SelectMgr_Selection)& operator() (const Standard_Integer Index)  const
{
  return Value(Index);
}
  ...
  Standard_EXPORT   Handle(SelectMgr_Selection)& ChangeValue (const Standard_Integer Index) ;
  Handle(SelectMgr_Selection)& operator() (const Standard_Integer Index) 
{
