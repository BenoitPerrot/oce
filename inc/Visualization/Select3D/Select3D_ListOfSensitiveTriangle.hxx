...
~Select3D_ListOfSensitiveTriangle()
{
  ...
  Standard_EXPORT   Handle(Select3D_SensitiveTriangle)& First()  const;
  
  Standard_EXPORT   Handle(Select3D_SensitiveTriangle)& Last()  const;
...
#endif // _Select3D_ListOfSensitiveTriangle_HeaderFile
