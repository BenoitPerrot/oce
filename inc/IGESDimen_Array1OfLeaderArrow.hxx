 ...
 const  IGESDimen_Array1OfLeaderArrow& operator = (const IGESDimen_Array1OfLeaderArrow& Other) 
{
  return Assign(Other);
   ...
   const  Handle(IGESDimen_LeaderArrow)& operator () (const Standard_Integer Index)  const
{
  return Value(Index);
}
  
      Handle(IGESDimen_LeaderArrow)& ChangeValue (const Standard_Integer Index) ;
    Handle(IGESDimen_LeaderArrow)& operator () (const Standard_Integer Index) 
{
...
#endif // _IGESDimen_Array1OfLeaderArrow_HeaderFile
