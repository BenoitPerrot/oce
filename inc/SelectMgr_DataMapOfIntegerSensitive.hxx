...
~SelectMgr_DataMapOfIntegerSensitive()
{
  ...
  Standard_EXPORT  const  Handle(SelectBasics_SensitiveEntity)& Find (const Standard_Integer& K)  const;
 const  Handle(SelectBasics_SensitiveEntity)& operator() (const Standard_Integer& K)  const
{
  return Find(K);
}
  
  Standard_EXPORT   Handle(SelectBasics_SensitiveEntity)& ChangeFind (const Standard_Integer& K) ;
  Handle(SelectBasics_SensitiveEntity)& operator() (const Standard_Integer& K) 
{
  return ChangeFind(K);
}
...
#endif // _SelectMgr_DataMapOfIntegerSensitive_HeaderFile
