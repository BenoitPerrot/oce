 ...
 const  StepBasic_Array1OfApproval& operator = (const StepBasic_Array1OfApproval& Other) 
{
  return Assign(Other);
   ...
   const  Handle(StepBasic_Approval)& operator () (const Standard_Integer Index)  const
{
  return Value(Index);
}
  
      Handle(StepBasic_Approval)& ChangeValue (const Standard_Integer Index) ;
    Handle(StepBasic_Approval)& operator () (const Standard_Integer Index) 
{
...
#define Array1Item Handle(StepBasic_Approval)
#define Array1Item_hxx <DataExchange/StepBasic/StepBasic_Approval.hxx>
#define TCollection_Array1 StepBasic_Array1OfApproval
#define TCollection_Array1_hxx <DataExchange/StepBasic/StepBasic_Array1OfApproval.hxx>
...
#endif // _StepBasic_Array1OfApproval_HeaderFile
