 ...
 const  MoniTool_SequenceOfElement& operator = (const MoniTool_SequenceOfElement& Other) 
{
  ...
  Standard_EXPORT  const  Handle(MoniTool_Element)& First()  const;
  
  Standard_EXPORT  const  Handle(MoniTool_Element)& Last()  const;
  
      void Split (const Standard_Integer Index, MoniTool_SequenceOfElement& Sub) ;
  
  Standard_EXPORT  const  Handle(MoniTool_Element)& Value (const Standard_Integer Index)  const;
 const  Handle(MoniTool_Element)& operator() (const Standard_Integer Index)  const
{
  return Value(Index);
}
  ...
  Standard_EXPORT   Handle(MoniTool_Element)& ChangeValue (const Standard_Integer Index) ;
  Handle(MoniTool_Element)& operator() (const Standard_Integer Index) 
{
...
#endif // _MoniTool_SequenceOfElement_HeaderFile
