 ...
 const  StepElement_Array2OfSurfaceElementPurposeMember& operator = (const StepElement_Array2OfSurfaceElementPurposeMember& Other) 
{
  return Assign(Other);
   ...
   const  Handle(StepElement_SurfaceElementPurposeMember)& operator() (const Standard_Integer Row, const Standard_Integer Col)  const
{
  return Value(Row,Col);
}
  
      Handle(StepElement_SurfaceElementPurposeMember)& ChangeValue (const Standard_Integer Row, const Standard_Integer Col) ;
    Handle(StepElement_SurfaceElementPurposeMember)& operator() (const Standard_Integer Row, const Standard_Integer Col) 
{
...
#define Array2Item_hxx <DataExchange/StepElement/StepElement_SurfaceElementPurposeMember.hxx>
#define TCollection_Array2 StepElement_Array2OfSurfaceElementPurposeMember
#define TCollection_Array2_hxx <DataExchange/StepElement/StepElement_Array2OfSurfaceElementPurposeMember.hxx>
...
#endif // _StepElement_Array2OfSurfaceElementPurposeMember_HeaderFile
