...
public:
  ...
  DEFINE_STANDARD_ALLOC
    ...
    IGESGraph_Array1OfTextDisplayTemplate(const Handle(IGESGraph_TextDisplayTemplate)& Item, const Standard_Integer Low, const Standard_Integer Up);
 ...
 const  IGESGraph_Array1OfTextDisplayTemplate& operator = (const IGESGraph_Array1OfTextDisplayTemplate& Other) 
{
  return Assign(Other);
   ...
   const  Handle(IGESGraph_TextDisplayTemplate)& operator () (const Standard_Integer Index)  const
{
  return Value(Index);
}
  
      Handle(IGESGraph_TextDisplayTemplate)& ChangeValue (const Standard_Integer Index) ;
    Handle(IGESGraph_TextDisplayTemplate)& operator () (const Standard_Integer Index) 
{
...
#endif // _IGESGraph_Array1OfTextDisplayTemplate_HeaderFile
