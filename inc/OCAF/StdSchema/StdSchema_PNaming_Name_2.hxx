...
#define _StdSchema_PNaming_Name_2_HeaderFile
...
DEFINE_STANDARD_HANDLE(StdSchema_PNaming_Name_2,Storage_CallBack)

class StdSchema_PNaming_Name_2 : public Storage_CallBack {
public:
  StdSchema_PNaming_Name_2() {}
  Standard_EXPORT static void SAdd(const Handle(PNaming_Name_2)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(StdSchema_PNaming_Name_2)
};
#endif
