...
#define _StdSchema_PNaming_Naming_2_HeaderFile
...
#include <OCAF/PNaming/Handle_PNaming_Naming_2.hxx>
#endif
...
DEFINE_STANDARD_HANDLE(StdSchema_PNaming_Naming_2,Storage_CallBack)

class StdSchema_PNaming_Naming_2 : public Storage_CallBack {
public:
  StdSchema_PNaming_Naming_2() {}
  Standard_EXPORT static void SAdd(const Handle(PNaming_Naming_2)& ,const Handle(Storage_Schema)&);
  ...
  DEFINE_STANDARD_RTTI(StdSchema_PNaming_Naming_2)
};
#endif
