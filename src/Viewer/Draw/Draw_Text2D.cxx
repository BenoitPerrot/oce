...
IMPLEMENT_STANDARD_TYPE(Draw_Text2D)
...
IMPLEMENT_STANDARD_TYPE_END(Draw_Text2D)
IMPLEMENT_DOWNCAST(Draw_Text2D,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(Draw_Text2D)
