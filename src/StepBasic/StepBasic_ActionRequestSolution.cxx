...
IMPLEMENT_STANDARD_TYPE_END(StepBasic_ActionRequestSolution)
IMPLEMENT_DOWNCAST(StepBasic_ActionRequestSolution,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepBasic_ActionRequestSolution)
