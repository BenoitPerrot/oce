...
IMPLEMENT_STANDARD_TYPE_END(IFSelect_AppliedModifiers)
IMPLEMENT_DOWNCAST(IFSelect_AppliedModifiers,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(IFSelect_AppliedModifiers)
