...
IMPLEMENT_STANDARD_TYPE(BinMDataStd_NoteBookDriver)
IMPLEMENT_STANDARD_SUPERTYPE_ARRAY()
  STANDARD_TYPE(BinMDF_ADriver),
  STANDARD_TYPE(MMgt_TShared),
  STANDARD_TYPE(Standard_Transient),
IMPLEMENT_STANDARD_SUPERTYPE_ARRAY_END()
IMPLEMENT_STANDARD_TYPE_END(BinMDataStd_NoteBookDriver)
IMPLEMENT_DOWNCAST(BinMDataStd_NoteBookDriver,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(BinMDataStd_NoteBookDriver)
#include <CDM_MessageDriver.hxx>
#include <TDF_Attribute.hxx>
