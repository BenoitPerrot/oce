...
void AppParCurves_MultiBSpCurve::Value (const Standard_Integer CuIndex, 
  ...
  BSplCLib::D0(U,0,myDegree,Standard_False,TabPoles,nullptr,
	       myknots->Array1(),&mymults->Array1(),Pt); // FIXME: probably incorrect
}
...
void AppParCurves_MultiBSpCurve::D1 (const Standard_Integer CuIndex, 
  ...
  BSplCLib::D1(U,0,myDegree,Standard_False,TabPoles,nullptr,
	       myknots->Array1(),&mymults->Array1(),Pt,V1); // FIXME: probably incorrect
}
...
void AppParCurves_MultiBSpCurve::D2 (const Standard_Integer CuIndex, 
  ...
  BSplCLib::D2(U,0,myDegree,Standard_False,TabPoles,nullptr,
	       myknots->Array1(),&mymults->Array1(),Pt,V1,V2); // FIXME: probably incorrect
}
