...
IMPLEMENT_STANDARD_TYPE(Geom2d_CartesianPoint)
IMPLEMENT_STANDARD_SUPERTYPE_ARRAY()
  STANDARD_TYPE(Geom2d_Point),
  STANDARD_TYPE(Geom2d_Geometry),
  STANDARD_TYPE(MMgt_TShared),
  STANDARD_TYPE(Standard_Transient),
IMPLEMENT_STANDARD_SUPERTYPE_ARRAY_END()
IMPLEMENT_STANDARD_TYPE_END(Geom2d_CartesianPoint)
IMPLEMENT_DOWNCAST(Geom2d_CartesianPoint,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(Geom2d_CartesianPoint)
