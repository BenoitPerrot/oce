...
IMPLEMENT_STANDARD_TYPE(BinMFunction_GraphNodeDriver)
IMPLEMENT_STANDARD_SUPERTYPE_ARRAY()
  STANDARD_TYPE(BinMDF_ADriver),
  STANDARD_TYPE(MMgt_TShared),
  STANDARD_TYPE(Standard_Transient),
IMPLEMENT_STANDARD_SUPERTYPE_ARRAY_END()
IMPLEMENT_STANDARD_TYPE_END(BinMFunction_GraphNodeDriver)
IMPLEMENT_DOWNCAST(BinMFunction_GraphNodeDriver,Standard_Transient)
