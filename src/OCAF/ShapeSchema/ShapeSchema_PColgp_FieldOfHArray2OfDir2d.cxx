...
#include <OCAF/ShapeSchema/ShapeSchema_PColgp_FieldOfHArray2OfDir2d.hxx>
#endif
...
void ShapeSchema_PColgp_FieldOfHArray2OfDir2d::SWrite(const PColgp_FieldOfHArray2OfDir2d& pp, Storage_BaseDriver& f, const Handle(Storage_Schema)& theSchema)
{
...
void ShapeSchema_PColgp_FieldOfHArray2OfDir2d::SRead(PColgp_FieldOfHArray2OfDir2d& pp, Storage_BaseDriver& f, const Handle(Storage_Schema)& theSchema)
{
  (void)theSchema; // dummy to avoid compiler warning on unused arg
