...
void ShapeSchema_PColStd_FieldOfHArray2OfReal::SWrite(const PColStd_FieldOfHArray2OfReal& pp, Storage_BaseDriver& f, const Handle(Storage_Schema)& theSchema)
{
...
void ShapeSchema_PColStd_FieldOfHArray2OfReal::SRead(PColStd_FieldOfHArray2OfReal& pp, Storage_BaseDriver& f, const Handle(Storage_Schema)& theSchema)
{
  (void)theSchema; // dummy to avoid compiler warning on unused arg
