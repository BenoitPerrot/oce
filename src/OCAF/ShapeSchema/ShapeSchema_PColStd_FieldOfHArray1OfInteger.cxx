...
#include <OCAF/ShapeSchema/ShapeSchema_PColStd_FieldOfHArray1OfInteger.hxx>
#endif
...
void ShapeSchema_PColStd_FieldOfHArray1OfInteger::SWrite(const PColStd_FieldOfHArray1OfInteger& pp, Storage_BaseDriver& f, const Handle(Storage_Schema)& theSchema)
{
...
void ShapeSchema_PColStd_FieldOfHArray1OfInteger::SRead(PColStd_FieldOfHArray1OfInteger& pp, Storage_BaseDriver& f, const Handle(Storage_Schema)& theSchema)
{
  (void)theSchema; // dummy to avoid compiler warning on unused arg
