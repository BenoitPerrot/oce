...
IMPLEMENT_STANDARD_TYPE_END(MDataStd_BooleanArrayRetrievalDriver)
IMPLEMENT_DOWNCAST(MDataStd_BooleanArrayRetrievalDriver,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(MDataStd_BooleanArrayRetrievalDriver)
