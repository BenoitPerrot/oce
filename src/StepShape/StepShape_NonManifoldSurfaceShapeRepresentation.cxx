...
IMPLEMENT_STANDARD_TYPE_END(StepShape_NonManifoldSurfaceShapeRepresentation)
IMPLEMENT_DOWNCAST(StepShape_NonManifoldSurfaceShapeRepresentation,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepShape_NonManifoldSurfaceShapeRepresentation)
