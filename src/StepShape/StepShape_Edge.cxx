...
IMPLEMENT_STANDARD_TYPE(StepShape_Edge)
...
IMPLEMENT_STANDARD_TYPE_END(StepShape_Edge)
IMPLEMENT_DOWNCAST(StepShape_Edge,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepShape_Edge)
