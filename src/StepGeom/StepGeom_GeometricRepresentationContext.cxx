...
IMPLEMENT_STANDARD_TYPE(StepGeom_GeometricRepresentationContext)
IMPLEMENT_STANDARD_SUPERTYPE_ARRAY()
  STANDARD_TYPE(StepRepr_RepresentationContext),
  STANDARD_TYPE(MMgt_TShared),
  STANDARD_TYPE(Standard_Transient),
IMPLEMENT_STANDARD_SUPERTYPE_ARRAY_END()
IMPLEMENT_STANDARD_TYPE_END(StepGeom_GeometricRepresentationContext)
IMPLEMENT_DOWNCAST(StepGeom_GeometricRepresentationContext,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepGeom_GeometricRepresentationContext)
