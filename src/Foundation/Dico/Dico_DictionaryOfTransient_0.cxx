...
IMPLEMENT_STANDARD_TYPE(Dico_DictionaryOfTransient)
IMPLEMENT_STANDARD_SUPERTYPE_ARRAY()
  STANDARD_TYPE(MMgt_TShared),
  STANDARD_TYPE(Standard_Transient),

IMPLEMENT_STANDARD_SUPERTYPE_ARRAY_END()
IMPLEMENT_STANDARD_TYPE_END(Dico_DictionaryOfTransient)


IMPLEMENT_DOWNCAST(Dico_DictionaryOfTransient,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(Dico_DictionaryOfTransient)
