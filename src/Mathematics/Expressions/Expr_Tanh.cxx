...
IMPLEMENT_STANDARD_TYPE(Expr_Tanh)
...
IMPLEMENT_STANDARD_TYPE_END(Expr_Tanh)
IMPLEMENT_DOWNCAST(Expr_Tanh,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(Expr_Tanh)
