...
IMPLEMENT_STANDARD_TYPE(Expr_Exponential)
...
IMPLEMENT_STANDARD_TYPE_END(Expr_Exponential)
IMPLEMENT_DOWNCAST(Expr_Exponential,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(Expr_Exponential)
