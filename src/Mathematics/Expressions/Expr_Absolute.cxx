...
IMPLEMENT_STANDARD_TYPE(Expr_Absolute)
...
IMPLEMENT_STANDARD_TYPE_END(Expr_Absolute)
IMPLEMENT_DOWNCAST(Expr_Absolute,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(Expr_Absolute)
