...
IMPLEMENT_STANDARD_TYPE(Expr_Sinh)
...
IMPLEMENT_STANDARD_TYPE_END(Expr_Sinh)
IMPLEMENT_DOWNCAST(Expr_Sinh,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(Expr_Sinh)
