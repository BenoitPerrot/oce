...
IMPLEMENT_STANDARD_TYPE(Expr_Sign)
...
IMPLEMENT_STANDARD_TYPE_END(Expr_Sign)
IMPLEMENT_DOWNCAST(Expr_Sign,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(Expr_Sign)
