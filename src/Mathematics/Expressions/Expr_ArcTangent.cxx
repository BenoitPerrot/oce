...
IMPLEMENT_STANDARD_TYPE(Expr_ArcTangent)
...
IMPLEMENT_STANDARD_TYPE_END(Expr_ArcTangent)
IMPLEMENT_DOWNCAST(Expr_ArcTangent,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(Expr_ArcTangent)
