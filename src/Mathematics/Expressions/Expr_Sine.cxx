...
IMPLEMENT_STANDARD_TYPE(Expr_Sine)
...
IMPLEMENT_STANDARD_TYPE_END(Expr_Sine)
IMPLEMENT_DOWNCAST(Expr_Sine,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(Expr_Sine)
