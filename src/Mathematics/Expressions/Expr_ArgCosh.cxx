...
IMPLEMENT_STANDARD_TYPE(Expr_ArgCosh)
...
IMPLEMENT_STANDARD_TYPE_END(Expr_ArgCosh)
IMPLEMENT_DOWNCAST(Expr_ArgCosh,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(Expr_ArgCosh)
