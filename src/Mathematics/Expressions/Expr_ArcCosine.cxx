...
IMPLEMENT_STANDARD_TYPE(Expr_ArcCosine)
...
IMPLEMENT_STANDARD_TYPE_END(Expr_ArcCosine)
IMPLEMENT_DOWNCAST(Expr_ArcCosine,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(Expr_ArcCosine)
