...
IMPLEMENT_STANDARD_TYPE(Expr_LogOfe)
...
IMPLEMENT_STANDARD_TYPE_END(Expr_LogOfe)
IMPLEMENT_DOWNCAST(Expr_LogOfe,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(Expr_LogOfe)
