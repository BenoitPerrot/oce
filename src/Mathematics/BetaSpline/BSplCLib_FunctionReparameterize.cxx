...
void BSplCLib::FunctionReparameterize(const BSplCLib_EvaluatorFunction& FunctionPtr,
...
void BSplCLib::FunctionReparameterize(const BSplCLib_EvaluatorFunction& FunctionPtr,
  ...
  BSplCLib::FunctionReparameterize(FunctionPtr, BSplineDegree, BSplineFlatKnots,
...
static void FunctionReparameterize(const BSplCLib_EvaluatorFunction& FunctionPtr,
				   const Standard_Integer BSplineDegree,
				   const TColStd_Array1OfReal& BSplineFlatKnots,
...
void BSplCLib::FunctionReparameterize(const BSplCLib_EvaluatorFunction& FunctionPtr,
				      ...
				      Standard_Integer& Status) {
  ::FunctionReparameterize(FunctionPtr, BSplineDegree, BSplineFlatKnots, Poles,
