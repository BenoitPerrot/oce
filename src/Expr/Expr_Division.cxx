...
IMPLEMENT_STANDARD_TYPE(Expr_Division)
...
IMPLEMENT_STANDARD_TYPE_END(Expr_Division)
IMPLEMENT_DOWNCAST(Expr_Division,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(Expr_Division)
