...
IMPLEMENT_STANDARD_TYPE_END(Interface_ReportEntity)
IMPLEMENT_DOWNCAST(Interface_ReportEntity,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(Interface_ReportEntity)
