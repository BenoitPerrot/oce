...
IMPLEMENT_STANDARD_TYPE_END(GeomTools_UndefinedTypeHandler)
IMPLEMENT_DOWNCAST(GeomTools_UndefinedTypeHandler,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(GeomTools_UndefinedTypeHandler)
