...
IMPLEMENT_STANDARD_TYPE(Select3D_ListNodeOfListOfSensitive)
...
IMPLEMENT_STANDARD_TYPE_END(Select3D_ListNodeOfListOfSensitive)


IMPLEMENT_DOWNCAST(Select3D_ListNodeOfListOfSensitive,Standard_Transient)
