...
IMPLEMENT_STANDARD_TYPE(Graphic3d_ArrayOfTriangles)
IMPLEMENT_STANDARD_SUPERTYPE_ARRAY()
  STANDARD_TYPE(Graphic3d_ArrayOfPrimitives),
  STANDARD_TYPE(MMgt_TShared),
  STANDARD_TYPE(Standard_Transient),
IMPLEMENT_STANDARD_SUPERTYPE_ARRAY_END()
IMPLEMENT_STANDARD_TYPE_END(Graphic3d_ArrayOfTriangles)
IMPLEMENT_DOWNCAST(Graphic3d_ArrayOfTriangles,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(Graphic3d_ArrayOfTriangles)
