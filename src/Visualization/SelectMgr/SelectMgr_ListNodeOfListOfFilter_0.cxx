...
IMPLEMENT_STANDARD_TYPE(SelectMgr_ListNodeOfListOfFilter)
...
IMPLEMENT_STANDARD_TYPE_END(SelectMgr_ListNodeOfListOfFilter)


IMPLEMENT_DOWNCAST(SelectMgr_ListNodeOfListOfFilter,Standard_Transient)
