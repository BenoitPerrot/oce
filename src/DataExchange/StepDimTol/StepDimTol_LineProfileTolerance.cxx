...
IMPLEMENT_STANDARD_TYPE_END(StepDimTol_LineProfileTolerance)
IMPLEMENT_DOWNCAST(StepDimTol_LineProfileTolerance,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepDimTol_LineProfileTolerance)
