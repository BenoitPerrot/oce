...
IMPLEMENT_STANDARD_TYPE_END(StepDimTol_DatumReference)
IMPLEMENT_DOWNCAST(StepDimTol_DatumReference,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepDimTol_DatumReference)
