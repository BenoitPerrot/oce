...
IMPLEMENT_STANDARD_TYPE(StepDimTol_CoaxialityTolerance)
...
IMPLEMENT_STANDARD_TYPE_END(StepDimTol_CoaxialityTolerance)
IMPLEMENT_DOWNCAST(StepDimTol_CoaxialityTolerance,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepDimTol_CoaxialityTolerance)
