...
IMPLEMENT_STANDARD_TYPE_END(StepDimTol_PositionTolerance)
IMPLEMENT_DOWNCAST(StepDimTol_PositionTolerance,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepDimTol_PositionTolerance)
