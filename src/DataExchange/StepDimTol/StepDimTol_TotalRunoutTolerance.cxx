...
IMPLEMENT_STANDARD_TYPE_END(StepDimTol_TotalRunoutTolerance)
IMPLEMENT_DOWNCAST(StepDimTol_TotalRunoutTolerance,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepDimTol_TotalRunoutTolerance)
