...
IMPLEMENT_STANDARD_TYPE(StepShape_SweptFaceSolid)
...
IMPLEMENT_STANDARD_TYPE_END(StepShape_SweptFaceSolid)
IMPLEMENT_DOWNCAST(StepShape_SweptFaceSolid,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepShape_SweptFaceSolid)
