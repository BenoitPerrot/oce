...
IMPLEMENT_STANDARD_TYPE_END(StepShape_RightCircularCylinder)
IMPLEMENT_DOWNCAST(StepShape_RightCircularCylinder,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepShape_RightCircularCylinder)
