...
IMPLEMENT_STANDARD_TYPE(StepShape_OrientedEdge)
...
IMPLEMENT_STANDARD_TYPE_END(StepShape_OrientedEdge)
IMPLEMENT_DOWNCAST(StepShape_OrientedEdge,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepShape_OrientedEdge)
