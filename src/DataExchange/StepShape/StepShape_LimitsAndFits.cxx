...
IMPLEMENT_STANDARD_TYPE(StepShape_LimitsAndFits)
IMPLEMENT_STANDARD_SUPERTYPE_ARRAY()
  STANDARD_TYPE(MMgt_TShared),
  STANDARD_TYPE(Standard_Transient),
IMPLEMENT_STANDARD_SUPERTYPE_ARRAY_END()
IMPLEMENT_STANDARD_TYPE_END(StepShape_LimitsAndFits)
IMPLEMENT_DOWNCAST(StepShape_LimitsAndFits,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepShape_LimitsAndFits)
