...
IMPLEMENT_STANDARD_TYPE_END(StepShape_EdgeBasedWireframeModel)
IMPLEMENT_DOWNCAST(StepShape_EdgeBasedWireframeModel,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepShape_EdgeBasedWireframeModel)
