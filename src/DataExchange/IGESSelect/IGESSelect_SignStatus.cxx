...
IMPLEMENT_STANDARD_TYPE_END(IGESSelect_SignStatus)
IMPLEMENT_DOWNCAST(IGESSelect_SignStatus,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(IGESSelect_SignStatus)
