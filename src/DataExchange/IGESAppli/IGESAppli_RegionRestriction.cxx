...
IMPLEMENT_STANDARD_TYPE(IGESAppli_RegionRestriction)
IMPLEMENT_STANDARD_SUPERTYPE_ARRAY()
  STANDARD_TYPE(IGESData_IGESEntity),
  STANDARD_TYPE(MMgt_TShared),
  STANDARD_TYPE(Standard_Transient),
IMPLEMENT_STANDARD_SUPERTYPE_ARRAY_END()
IMPLEMENT_STANDARD_TYPE_END(IGESAppli_RegionRestriction)
IMPLEMENT_DOWNCAST(IGESAppli_RegionRestriction,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(IGESAppli_RegionRestriction)
