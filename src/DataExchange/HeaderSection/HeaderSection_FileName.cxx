...
IMPLEMENT_STANDARD_TYPE_END(HeaderSection_FileName)
IMPLEMENT_DOWNCAST(HeaderSection_FileName,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(HeaderSection_FileName)
