...
IMPLEMENT_STANDARD_TYPE(StepFEA_Node)
...
IMPLEMENT_STANDARD_TYPE_END(StepFEA_Node)
IMPLEMENT_DOWNCAST(StepFEA_Node,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepFEA_Node)
