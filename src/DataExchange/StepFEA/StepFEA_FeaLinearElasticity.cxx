...
IMPLEMENT_STANDARD_TYPE(StepFEA_FeaLinearElasticity)
...
IMPLEMENT_STANDARD_TYPE_END(StepFEA_FeaLinearElasticity)
IMPLEMENT_DOWNCAST(StepFEA_FeaLinearElasticity,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepFEA_FeaLinearElasticity)
