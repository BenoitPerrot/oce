...
IMPLEMENT_STANDARD_TYPE_END(StepFEA_FeaRepresentationItem)
IMPLEMENT_DOWNCAST(StepFEA_FeaRepresentationItem,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepFEA_FeaRepresentationItem)
