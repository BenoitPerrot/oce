...
IMPLEMENT_STANDARD_TYPE_END(StepFEA_FeaShellBendingStiffness)
IMPLEMENT_DOWNCAST(StepFEA_FeaShellBendingStiffness,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepFEA_FeaShellBendingStiffness)
