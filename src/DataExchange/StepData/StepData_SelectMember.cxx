...
IMPLEMENT_STANDARD_TYPE(StepData_SelectMember)
IMPLEMENT_STANDARD_SUPERTYPE_ARRAY()
  STANDARD_TYPE(MMgt_TShared),
  STANDARD_TYPE(Standard_Transient),
IMPLEMENT_STANDARD_SUPERTYPE_ARRAY_END()
IMPLEMENT_STANDARD_TYPE_END(StepData_SelectMember)
IMPLEMENT_DOWNCAST(StepData_SelectMember,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepData_SelectMember)
