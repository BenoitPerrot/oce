...
IMPLEMENT_STANDARD_TYPE_END(IGESSolid_PlaneSurface)
IMPLEMENT_DOWNCAST(IGESSolid_PlaneSurface,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(IGESSolid_PlaneSurface)
