...
IMPLEMENT_STANDARD_TYPE_END(IGESGeom_OffsetSurface)
IMPLEMENT_DOWNCAST(IGESGeom_OffsetSurface,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(IGESGeom_OffsetSurface)
