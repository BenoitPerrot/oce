...
IMPLEMENT_STANDARD_TYPE(IGESGeom_GeneralModule)
...
IMPLEMENT_STANDARD_TYPE_END(IGESGeom_GeneralModule)
IMPLEMENT_DOWNCAST(IGESGeom_GeneralModule,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(IGESGeom_GeneralModule)
