...
IMPLEMENT_STANDARD_TYPE_END(StepRepr_ItemDefinedTransformation)
IMPLEMENT_DOWNCAST(StepRepr_ItemDefinedTransformation,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepRepr_ItemDefinedTransformation)
