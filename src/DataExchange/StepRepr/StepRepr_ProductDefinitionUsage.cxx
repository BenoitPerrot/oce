...
IMPLEMENT_STANDARD_TYPE_END(StepRepr_ProductDefinitionUsage)
IMPLEMENT_DOWNCAST(StepRepr_ProductDefinitionUsage,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepRepr_ProductDefinitionUsage)
