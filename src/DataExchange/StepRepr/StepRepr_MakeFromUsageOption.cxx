...
IMPLEMENT_STANDARD_TYPE_END(StepRepr_MakeFromUsageOption)
IMPLEMENT_DOWNCAST(StepRepr_MakeFromUsageOption,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepRepr_MakeFromUsageOption)
