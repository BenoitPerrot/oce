...
IMPLEMENT_STANDARD_TYPE_END(StepRepr_ShapeAspectTransition)
IMPLEMENT_DOWNCAST(StepRepr_ShapeAspectTransition,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepRepr_ShapeAspectTransition)
