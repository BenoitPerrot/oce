...
IMPLEMENT_STANDARD_TYPE_END(StepBasic_GeneralProperty)
IMPLEMENT_DOWNCAST(StepBasic_GeneralProperty,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepBasic_GeneralProperty)
