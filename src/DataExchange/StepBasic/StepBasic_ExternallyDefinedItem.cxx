...
IMPLEMENT_STANDARD_TYPE_END(StepBasic_ExternallyDefinedItem)
IMPLEMENT_DOWNCAST(StepBasic_ExternallyDefinedItem,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepBasic_ExternallyDefinedItem)
