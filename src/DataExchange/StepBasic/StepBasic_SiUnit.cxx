...
IMPLEMENT_STANDARD_TYPE(StepBasic_SiUnit)
IMPLEMENT_STANDARD_SUPERTYPE_ARRAY()
  STANDARD_TYPE(StepBasic_NamedUnit),
  STANDARD_TYPE(MMgt_TShared),
  STANDARD_TYPE(Standard_Transient),
IMPLEMENT_STANDARD_SUPERTYPE_ARRAY_END()
IMPLEMENT_STANDARD_TYPE_END(StepBasic_SiUnit)
IMPLEMENT_DOWNCAST(StepBasic_SiUnit,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepBasic_SiUnit)
