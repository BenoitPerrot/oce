...
IMPLEMENT_STANDARD_TYPE_END(StepBasic_DocumentProductAssociation)
IMPLEMENT_DOWNCAST(StepBasic_DocumentProductAssociation,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepBasic_DocumentProductAssociation)
