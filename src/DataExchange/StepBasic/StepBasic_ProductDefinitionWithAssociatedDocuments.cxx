...
IMPLEMENT_STANDARD_TYPE_END(StepBasic_ProductDefinitionWithAssociatedDocuments)
IMPLEMENT_DOWNCAST(StepBasic_ProductDefinitionWithAssociatedDocuments,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepBasic_ProductDefinitionWithAssociatedDocuments)
