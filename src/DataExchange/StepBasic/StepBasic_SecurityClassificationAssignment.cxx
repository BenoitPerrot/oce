...
IMPLEMENT_STANDARD_TYPE_END(StepBasic_SecurityClassificationAssignment)
IMPLEMENT_DOWNCAST(StepBasic_SecurityClassificationAssignment,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepBasic_SecurityClassificationAssignment)
