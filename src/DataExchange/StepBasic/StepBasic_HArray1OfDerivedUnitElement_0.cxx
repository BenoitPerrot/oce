...
IMPLEMENT_STANDARD_TYPE(StepBasic_HArray1OfDerivedUnitElement)
IMPLEMENT_STANDARD_SUPERTYPE_ARRAY()
  STANDARD_TYPE(MMgt_TShared),
  STANDARD_TYPE(Standard_Transient),

IMPLEMENT_STANDARD_SUPERTYPE_ARRAY_END()
IMPLEMENT_STANDARD_TYPE_END(StepBasic_HArray1OfDerivedUnitElement)


IMPLEMENT_DOWNCAST(StepBasic_HArray1OfDerivedUnitElement,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepBasic_HArray1OfDerivedUnitElement)
