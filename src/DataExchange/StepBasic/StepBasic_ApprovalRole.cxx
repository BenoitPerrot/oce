...
IMPLEMENT_STANDARD_TYPE_END(StepBasic_ApprovalRole)
IMPLEMENT_DOWNCAST(StepBasic_ApprovalRole,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepBasic_ApprovalRole)
