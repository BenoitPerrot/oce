...
IMPLEMENT_STANDARD_TYPE_END(StepBasic_IdentificationAssignment)
IMPLEMENT_DOWNCAST(StepBasic_IdentificationAssignment,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepBasic_IdentificationAssignment)
