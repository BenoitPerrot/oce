...
IMPLEMENT_STANDARD_TYPE_END(StepBasic_DocumentUsageConstraint)
IMPLEMENT_DOWNCAST(StepBasic_DocumentUsageConstraint,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepBasic_DocumentUsageConstraint)
