...
IMPLEMENT_STANDARD_TYPE_END(StepBasic_DocumentRepresentationType)
IMPLEMENT_DOWNCAST(StepBasic_DocumentRepresentationType,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepBasic_DocumentRepresentationType)
