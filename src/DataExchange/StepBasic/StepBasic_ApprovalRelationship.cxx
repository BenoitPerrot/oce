...
IMPLEMENT_STANDARD_TYPE_END(StepBasic_ApprovalRelationship)
IMPLEMENT_DOWNCAST(StepBasic_ApprovalRelationship,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepBasic_ApprovalRelationship)
