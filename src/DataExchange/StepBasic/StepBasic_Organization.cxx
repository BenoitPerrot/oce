...
IMPLEMENT_STANDARD_TYPE_END(StepBasic_Organization)
IMPLEMENT_DOWNCAST(StepBasic_Organization,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepBasic_Organization)
