...
IMPLEMENT_STANDARD_TYPE_END(IGESBasic_OrderedGroup)
IMPLEMENT_DOWNCAST(IGESBasic_OrderedGroup,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(IGESBasic_OrderedGroup)
