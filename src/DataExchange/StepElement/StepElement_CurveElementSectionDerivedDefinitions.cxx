...
IMPLEMENT_STANDARD_TYPE_END(StepElement_CurveElementSectionDerivedDefinitions)
IMPLEMENT_DOWNCAST(StepElement_CurveElementSectionDerivedDefinitions,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepElement_CurveElementSectionDerivedDefinitions)
