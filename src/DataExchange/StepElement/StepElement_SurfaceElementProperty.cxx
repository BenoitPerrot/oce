...
IMPLEMENT_STANDARD_TYPE_END(StepElement_SurfaceElementProperty)
IMPLEMENT_DOWNCAST(StepElement_SurfaceElementProperty,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepElement_SurfaceElementProperty)
