...
IMPLEMENT_STANDARD_TYPE_END(IFSelect_SelectControl)
IMPLEMENT_DOWNCAST(IFSelect_SelectControl,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(IFSelect_SelectControl)
