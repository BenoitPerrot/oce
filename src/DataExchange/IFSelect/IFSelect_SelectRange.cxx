...
IMPLEMENT_STANDARD_TYPE(IFSelect_SelectRange)
...
IMPLEMENT_STANDARD_TYPE_END(IFSelect_SelectRange)
IMPLEMENT_DOWNCAST(IFSelect_SelectRange,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(IFSelect_SelectRange)
#include <stdio.h>
