...
IMPLEMENT_STANDARD_TYPE(IFSelect_SelectExtract)
...
IMPLEMENT_STANDARD_TYPE_END(IFSelect_SelectExtract)
IMPLEMENT_DOWNCAST(IFSelect_SelectExtract,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(IFSelect_SelectExtract)
