...
IMPLEMENT_STANDARD_TYPE(Vrml_Coordinate3)
IMPLEMENT_STANDARD_SUPERTYPE_ARRAY()
  STANDARD_TYPE(MMgt_TShared),
  STANDARD_TYPE(Standard_Transient),
IMPLEMENT_STANDARD_SUPERTYPE_ARRAY_END()
IMPLEMENT_STANDARD_TYPE_END(Vrml_Coordinate3)
IMPLEMENT_DOWNCAST(Vrml_Coordinate3,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(Vrml_Coordinate3)
