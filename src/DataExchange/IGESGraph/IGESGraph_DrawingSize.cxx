...
IMPLEMENT_STANDARD_TYPE_END(IGESGraph_DrawingSize)
IMPLEMENT_DOWNCAST(IGESGraph_DrawingSize,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(IGESGraph_DrawingSize)
