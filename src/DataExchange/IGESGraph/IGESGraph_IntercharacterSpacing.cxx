...
IMPLEMENT_STANDARD_TYPE_END(IGESGraph_IntercharacterSpacing)
IMPLEMENT_DOWNCAST(IGESGraph_IntercharacterSpacing,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(IGESGraph_IntercharacterSpacing)
