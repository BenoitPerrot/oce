...
IMPLEMENT_STANDARD_TYPE_END(IGESGraph_LineFontDefTemplate)
IMPLEMENT_DOWNCAST(IGESGraph_LineFontDefTemplate,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(IGESGraph_LineFontDefTemplate)
