...
IMPLEMENT_STANDARD_TYPE(STEPCAFControl_DictionaryOfExternFile)
IMPLEMENT_STANDARD_SUPERTYPE_ARRAY()
  STANDARD_TYPE(MMgt_TShared),
  STANDARD_TYPE(Standard_Transient),

IMPLEMENT_STANDARD_SUPERTYPE_ARRAY_END()
IMPLEMENT_STANDARD_TYPE_END(STEPCAFControl_DictionaryOfExternFile)


IMPLEMENT_DOWNCAST(STEPCAFControl_DictionaryOfExternFile,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(STEPCAFControl_DictionaryOfExternFile)
