...
IMPLEMENT_STANDARD_TYPE_END(IGESDimen_DimensionUnits)
IMPLEMENT_DOWNCAST(IGESDimen_DimensionUnits,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(IGESDimen_DimensionUnits)
