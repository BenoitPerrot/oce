...
IMPLEMENT_STANDARD_TYPE_END(IGESDimen_DimensionTolerance)
IMPLEMENT_DOWNCAST(IGESDimen_DimensionTolerance,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(IGESDimen_DimensionTolerance)
