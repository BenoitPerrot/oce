...
IMPLEMENT_STANDARD_TYPE_END(StepVisual_FillAreaStyle)
IMPLEMENT_DOWNCAST(StepVisual_FillAreaStyle,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepVisual_FillAreaStyle)
