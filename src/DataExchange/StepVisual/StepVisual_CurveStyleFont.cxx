...
IMPLEMENT_STANDARD_TYPE_END(StepVisual_CurveStyleFont)
IMPLEMENT_DOWNCAST(StepVisual_CurveStyleFont,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepVisual_CurveStyleFont)
