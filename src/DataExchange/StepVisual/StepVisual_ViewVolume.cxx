...
IMPLEMENT_STANDARD_TYPE_END(StepVisual_ViewVolume)
IMPLEMENT_DOWNCAST(StepVisual_ViewVolume,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepVisual_ViewVolume)
