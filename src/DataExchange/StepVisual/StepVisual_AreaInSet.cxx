...
IMPLEMENT_STANDARD_TYPE_END(StepVisual_AreaInSet)
IMPLEMENT_DOWNCAST(StepVisual_AreaInSet,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepVisual_AreaInSet)
