...
IMPLEMENT_STANDARD_TYPE(StepVisual_PresentationSize)
IMPLEMENT_STANDARD_SUPERTYPE_ARRAY()
  STANDARD_TYPE(MMgt_TShared),
  STANDARD_TYPE(Standard_Transient),
IMPLEMENT_STANDARD_SUPERTYPE_ARRAY_END()
IMPLEMENT_STANDARD_TYPE_END(StepVisual_PresentationSize)
IMPLEMENT_DOWNCAST(StepVisual_PresentationSize,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepVisual_PresentationSize)
