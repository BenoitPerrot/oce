...
IMPLEMENT_STANDARD_TYPE(StepVisual_SurfaceStyleSilhouette)
IMPLEMENT_STANDARD_SUPERTYPE_ARRAY()
  STANDARD_TYPE(MMgt_TShared),
  STANDARD_TYPE(Standard_Transient),
IMPLEMENT_STANDARD_SUPERTYPE_ARRAY_END()
IMPLEMENT_STANDARD_TYPE_END(StepVisual_SurfaceStyleSilhouette)
IMPLEMENT_DOWNCAST(StepVisual_SurfaceStyleSilhouette,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepVisual_SurfaceStyleSilhouette)
