...
IMPLEMENT_STANDARD_TYPE(StepVisual_CurveStyleFontPattern)
IMPLEMENT_STANDARD_SUPERTYPE_ARRAY()
  STANDARD_TYPE(MMgt_TShared),
  STANDARD_TYPE(Standard_Transient),
IMPLEMENT_STANDARD_SUPERTYPE_ARRAY_END()
IMPLEMENT_STANDARD_TYPE_END(StepVisual_CurveStyleFontPattern)
IMPLEMENT_DOWNCAST(StepVisual_CurveStyleFontPattern,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepVisual_CurveStyleFontPattern)
