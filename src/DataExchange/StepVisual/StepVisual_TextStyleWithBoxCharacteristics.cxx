...
IMPLEMENT_STANDARD_TYPE_END(StepVisual_TextStyleWithBoxCharacteristics)
IMPLEMENT_DOWNCAST(StepVisual_TextStyleWithBoxCharacteristics,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepVisual_TextStyleWithBoxCharacteristics)
