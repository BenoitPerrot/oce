...
IMPLEMENT_STANDARD_TYPE_END(TransferBRep_TransferResultInfo)
IMPLEMENT_DOWNCAST(TransferBRep_TransferResultInfo,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(TransferBRep_TransferResultInfo)
