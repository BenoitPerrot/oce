...
IMPLEMENT_STANDARD_TYPE_END(StepGeom_RationalBSplineSurface)
IMPLEMENT_DOWNCAST(StepGeom_RationalBSplineSurface,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepGeom_RationalBSplineSurface)
