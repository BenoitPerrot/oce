...
IMPLEMENT_STANDARD_TYPE(StepGeom_BSplineSurface)
...
IMPLEMENT_STANDARD_TYPE_END(StepGeom_BSplineSurface)
IMPLEMENT_DOWNCAST(StepGeom_BSplineSurface,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepGeom_BSplineSurface)
