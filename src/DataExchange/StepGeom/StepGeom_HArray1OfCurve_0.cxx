...
IMPLEMENT_STANDARD_TYPE(StepGeom_HArray1OfCurve)
IMPLEMENT_STANDARD_SUPERTYPE_ARRAY()
  STANDARD_TYPE(MMgt_TShared),
  STANDARD_TYPE(Standard_Transient),

IMPLEMENT_STANDARD_SUPERTYPE_ARRAY_END()
IMPLEMENT_STANDARD_TYPE_END(StepGeom_HArray1OfCurve)


IMPLEMENT_DOWNCAST(StepGeom_HArray1OfCurve,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepGeom_HArray1OfCurve)
