...
IMPLEMENT_STANDARD_TYPE(StepGeom_BezierSurface)
...
IMPLEMENT_STANDARD_TYPE_END(StepGeom_BezierSurface)
IMPLEMENT_DOWNCAST(StepGeom_BezierSurface,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepGeom_BezierSurface)
