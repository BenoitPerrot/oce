...
IMPLEMENT_STANDARD_TYPE_END(StepGeom_SurfacePatch)
IMPLEMENT_DOWNCAST(StepGeom_SurfacePatch,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepGeom_SurfacePatch)
