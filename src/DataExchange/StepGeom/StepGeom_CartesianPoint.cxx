...
IMPLEMENT_STANDARD_TYPE(StepGeom_CartesianPoint)
...
IMPLEMENT_STANDARD_TYPE_END(StepGeom_CartesianPoint)
IMPLEMENT_DOWNCAST(StepGeom_CartesianPoint,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepGeom_CartesianPoint)
