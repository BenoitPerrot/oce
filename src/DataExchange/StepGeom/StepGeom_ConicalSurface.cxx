...
IMPLEMENT_STANDARD_TYPE(StepGeom_ConicalSurface)
...
IMPLEMENT_STANDARD_TYPE_END(StepGeom_ConicalSurface)
IMPLEMENT_DOWNCAST(StepGeom_ConicalSurface,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(StepGeom_ConicalSurface)
