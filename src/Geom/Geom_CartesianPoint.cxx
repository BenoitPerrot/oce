...
IMPLEMENT_STANDARD_TYPE(Geom_CartesianPoint)
...
IMPLEMENT_STANDARD_TYPE_END(Geom_CartesianPoint)
IMPLEMENT_DOWNCAST(Geom_CartesianPoint,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(Geom_CartesianPoint)
