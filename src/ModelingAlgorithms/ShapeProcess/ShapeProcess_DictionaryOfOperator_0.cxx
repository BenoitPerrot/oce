...
IMPLEMENT_STANDARD_TYPE(ShapeProcess_DictionaryOfOperator)
IMPLEMENT_STANDARD_SUPERTYPE_ARRAY()
  STANDARD_TYPE(MMgt_TShared),
  STANDARD_TYPE(Standard_Transient),

IMPLEMENT_STANDARD_SUPERTYPE_ARRAY_END()
IMPLEMENT_STANDARD_TYPE_END(ShapeProcess_DictionaryOfOperator)


IMPLEMENT_DOWNCAST(ShapeProcess_DictionaryOfOperator,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(ShapeProcess_DictionaryOfOperator)
