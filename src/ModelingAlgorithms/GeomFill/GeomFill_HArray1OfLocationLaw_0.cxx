...
IMPLEMENT_STANDARD_TYPE(GeomFill_HArray1OfLocationLaw)
IMPLEMENT_STANDARD_SUPERTYPE_ARRAY()
  STANDARD_TYPE(MMgt_TShared),
  STANDARD_TYPE(Standard_Transient),

IMPLEMENT_STANDARD_SUPERTYPE_ARRAY_END()
IMPLEMENT_STANDARD_TYPE_END(GeomFill_HArray1OfLocationLaw)


IMPLEMENT_DOWNCAST(GeomFill_HArray1OfLocationLaw,Standard_Transient)
