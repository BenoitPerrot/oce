...
//    Standard_Real f1,l1; Handle(Geom2d_Curve) PC1 = BRep_Tool::CurveOnSurface(e1,F,f1,l1);  
    ...
    gp_Vec2d dd2d; Standard_Real dd=0;
    if (inU) {dd = o2d1.X()-o2d.X(); dd2d = gp_Vec2d(dd,0.);}
    else     {dd = o2d1.Y()-o2d.Y(); dd2d = gp_Vec2d(0.,dd);}        

    if (Abs(dd)<tolx) return Standard_False;
    TopOpeBRepTool_TOOL::TrslUVModifE(dd2d,FFOR,E); //FUN_tool_ttranslate(dxx,FFOR,E);
  } // ex(FFOR)
  return Standard_False;
}
